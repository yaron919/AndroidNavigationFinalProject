...
public class testNavigationView extends AppCompatActivity implements OnNavigationReadyCallback,RouteListener, NavigationListener,ProgressChangeListener {

    private static final String TAG = testNavigationView.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView = findViewById(R.id.navigation_view_test);
